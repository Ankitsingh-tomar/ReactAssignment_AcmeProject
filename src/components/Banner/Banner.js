    ...
    <div className="hero-section">
        <div className="container">
            <div className="hero-wrapper">
                <h1 className="hero-heading">Serving you <br/>since 1989. </h1>
                <p className="hero-paragraph">Acme Outdoors is an outdoor and adventure shop located in the Boathouse District in Oklahoma City.</p>
                {/* <button type="button" className="btn btn-outline-light">Light</button> */}
                <div className="hero-button-wrapper">
                    <a href="/shop" className="btn btn-outline-light">Shop Merch</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div className="container">
            <div className="support-top-wrapper">
                ...
                <div className="support-top-right">
                    <p>COVID-19 has forced us to close our retail space, but we need support from patrons like yourself now more than ever. Below, we’ve listed the best ways to help us through this season.</p></div>
            </div>
    ...
    <div className="safe-section">
        <div className="container">
            <div className="safe-wrapper">
                <h2 className="safe-heading">How we're keeping you safe during COVID-19</h2><p className="safe-paragraph">As an outdoor shop, we’ve taken precautionary measures to ensure the safety of all our customers and team members.</p>
                <div className="safe-button-wrapper">
                    <a href="/alert/how-were-responding-to-covid-19" className="btn light hero safe w-button">Read Our Statement</a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div className="shop-local-wrapper">
                ...
                <div className="shop-local-right">
                    <div className="shop-local-content-wrapper">
                        ...
                        <p>We know that during COVID-19, a lot of folks around the city and state are feeling uneasy about the future - we’re not sure what the future holds either.</p><p>That said: we know that we love making sure you have the gear you need for your adventures, and we’re going to keep doing that - with our team - until the city tells us we can’t.</p><p>But as long as folks like yourself support small businesses around the city, then we’ll be here — every day, making sure your orders arrive on time.</p><p>-------</p>
